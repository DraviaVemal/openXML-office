...
(
    ...
    color_rgb           TEXT,                              -- Color RGB
    color_theme         INTEGER,                           -- Color Theme
...
INSERT INTO number_formats (format_code, format_id)
VALUES (?, ?);

-- query : insert_font_style_table# 
INSERT INTO font_style (font_name,
                        color_rgb,
                        color_theme,
                        family_id,
                        font_size,
...
INSERT INTO fill_style (background_color_setting,
                        foreground_color_setting,
                        pattern_type)
VALUES (?, ?, ?);

-- query : insert_border_style_table# 
INSERT INTO border_style (left_border,
                          top_border,
                          right_border,
                          bottom_border)
VALUES (?, ?, ?, ?);
...
INSERT INTO cell_xfs (format_id,
                      number_format_id,
                      font_id,
                      fill_id,
                      border_id,
...
-- query : select_share_string_table# 
SELECT background_color_setting,
       foreground_color_setting,
       pattern_type
FROM fill_style
ORDER BY id;
